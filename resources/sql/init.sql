...
CREATE OR REPLACE TABLE PROTECTED_DEVICE {
    ID          UUID        PRIMARY KEY,
    PUBLICKEY   BYTEA,
    MODELID     UUID
};
...
CREATE OR REPLACE TABLE MODEL_COMPONENT {
    MODELID     INTEGER,
    COMPONENTID INTEGER
},

CREATE OR REPLACE TABLE COUNTRY {
    NUMERICCODE NUMERIC(3)  PRIMARY KEY,
    ALPHA3CODE  CHAR(3)     NOT NULL UNIQUE,
    ALPHA2CODE  CHAR(2)     NOT NULL UNIQUE,
...
CREATE OR REPLACE TABLE PUBLIC_DEVICE {
    ID          UUID        PRIMARY KEY,
